...
class BO_LiqTransfer:
    def __init__(self, 
        ...
        self.platform = None    # NOTE: for close loop only
        return
    ...
    def set_bounds(self, x_train:Iterable):
    ...
    def optimized_suggestions(self, random_state:int = 42):
    ...
    def cleanTip(self, source_well, repetitions:int = 2):
